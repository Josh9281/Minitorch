...
class Network(minitorch.Module):
    def __init__(self, hidden_layers):
        ...
        self.layer1 = Linear(2, hidden_layers)  # takes 2 input features (input dimension of 2) and produces an output of size hidden_layers
        self.layer2 = Linear(hidden_layers, hidden_layers)  # Hidden layer to next hidden layer
        self.layer3 = Linear(hidden_layers, 1)  # reduces the output from the hidden layer to 1 output
